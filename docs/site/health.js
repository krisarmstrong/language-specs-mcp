...
function statusClass(language) {
  ...
  const freshness =
    (_a = language.freshnessDays) !== null && _a !== void 0 ? _a : Number.MAX_SAFE_INTEGER;
...
async function init() {
  ...
  searchGeneratedEl.textContent = formatDate(
    (_a = data.searchIndexGeneratedAt) !== null && _a !== void 0 ? _a : null,
  );
  languagesEl.textContent = String(data.languages.length);
  const staleCount = data.languages.filter((lang) => {
    var _a;
    return (
      !lang.fetchedAt ||
      ((_a = lang.freshnessDays) !== null && _a !== void 0 ? _a : Number.MAX_SAFE_INTEGER) > 30
    );
  }).length;
