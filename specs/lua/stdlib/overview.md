...
# https://www.lua.org/ Lua 5.4 Reference Manual 

 by Roberto Ierusalimschy, Luiz Henrique de Figueiredo, Waldemar Celes 

 Copyright © 2020–2025 Lua.org, PUC-Rio. Freely available under the terms of the [Lua license](https://www.lua.org/license.html). [contents](contents.html#contents) · [index](contents.html#index) · [other versions](https://www.lua.org/manual/)
