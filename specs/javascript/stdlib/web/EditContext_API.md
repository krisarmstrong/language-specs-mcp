...
- [Report feedback](https://survey.alchemer.com/s3/7634825/MDN-baseline-feedback?page=%2Fen-US%2Fdocs%2FWeb%2FAPI%2FEditContext_API&level=not)

Experimental:This is an [experimental technology](/en-US/docs/MDN/Writing_guidelines/Experimental_deprecated_obsolete#experimental)
Check the [Browser compatibility table](#browser_compatibility) carefully before using this in production.

The EditContext API can be used to build rich text editors on the web that support advanced text input experiences, such as [Input Method Editor](/en-US/docs/Glossary/Input_method_editor) (IME) composition, emoji picker, or any other platform-specific editing-related UI surfaces.
...
[Input method software](#input_method_software)

The input method software converts the user's input into text. For example, this could be an [Input Method Editor](/en-US/docs/Glossary/Input_method_editor) (IME) that converts keystrokes from a standard keyboard into Japanese, Chinese, or Korean characters.

[OS text input service](#os_text_input_service)

The text input service of the operating system acts as a link between the input method software and the application.

[Application text edit context](#application_text_edit_context)
...
[Application editable region](#application_editable_region)
...
### [Creating custom editable regions](#creating_custom_editable_regions)
...
### [Author's responsibilities](#authors_responsibilities)
...
To use the EditContext API, you need to create an instance of the [EditContext](/en-US/docs/Web/API/EditContext) interface, and then attach it to the DOM element you want to make editable by using the [editContext](/en-US/docs/Web/API/HTMLElement/editContext) property. The DOM element can be any element, including a `<div>` or a `<canvas>` element.
...
### [Model and view architecture](#model_and_view_architecture)
...
[EditContext](/en-US/docs/Web/API/EditContext)Experimental
...
[TextFormat](/en-US/docs/Web/API/TextFormat)Experimental
...
[TextUpdateEvent](/en-US/docs/Web/API/TextUpdateEvent)Experimental
...
[TextFormatUpdateEvent](/en-US/docs/Web/API/TextFormatUpdateEvent)Experimental
...
[CharacterBoundsUpdateEvent](/en-US/docs/Web/API/CharacterBoundsUpdateEvent)Experimental
...
The `editContext` property of the [HTMLElement](/en-US/docs/Web/API/HTMLElement) interface gets and sets an element's associated [EditContext](/en-US/docs/Web/API/EditContext) object.
...
Was this page helpful to you?YesNo[Learn how to contribute](/en-US/docs/MDN/Community/Getting_started)
 ...
 This page was last modified on ⁨Apr 10, 2025⁩ by [MDN contributors](/en-US/docs/Web/API/EditContext_API/contributors.txt). 

[View this page on GitHub](https://github.com/mdn/content/blob/main/files/en-us/web/api/editcontext_api/index.md?plain=1) • [Report a problem with this content](https://github.com/mdn/content/issues/new?template=page-report.yml&mdn-url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FEditContext_API&metadata=%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EPage+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Feditcontext_api%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FEditContext_API%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Feditcontext_api%2Findex.md%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2Fe9b6cd1b7fa8612257b72b2a85a96dd7d45c0200%0A*+Document+last+modified%3A+2025-04-10T14%3A56%3A07.000Z%0A%0A%3C%2Fdetails%3E)
