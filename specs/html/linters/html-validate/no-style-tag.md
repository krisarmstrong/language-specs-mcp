HTML-validate - Disallow usage of <style> tag (no-style-tag)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/no-style-tag.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/no-style-tag.ts)
