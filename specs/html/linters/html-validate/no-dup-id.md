HTML-validate - Disallow duplicated IDs (no-dup-id)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/no-dup-id.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/no-dup-id.ts)
