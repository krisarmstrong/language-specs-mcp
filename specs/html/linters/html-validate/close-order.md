HTML-validate - Require elements to be closed in correct order (close-order)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/close-order.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/close-order.ts)
