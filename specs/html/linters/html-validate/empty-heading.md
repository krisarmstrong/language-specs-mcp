HTML-validate - Require headings to have textual content (empty-heading)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/empty-heading.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/empty-heading.ts)
