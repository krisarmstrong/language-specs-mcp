HTML-validate - Require CSP nonce for resources (require-csp-nonce)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/require-csp-nonce.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/require-csp-nonce.ts)
