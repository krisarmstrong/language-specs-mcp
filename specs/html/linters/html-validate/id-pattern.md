HTML-validate - Require IDs to match a specific pattern (id-pattern)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/id-pattern.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/id-pattern.ts)
