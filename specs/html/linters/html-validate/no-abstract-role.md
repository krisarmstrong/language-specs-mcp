HTML-validate - Disallow usage of abstract WAI-ARIA roles (no-abstract-role)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/no-abstract-role.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/no-abstract-role.ts)
