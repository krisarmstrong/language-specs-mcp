HTML-validate - Disallow usage of redundant label for attributes (no-redundant-for)Toggle navigation[HTML-validate v10.5.0](/)
...
[Edit this page](https://gitlab.com/html-validate/html-validate/edit/master/docs/rules/no-redundant-for.md)[View rule source](https://gitlab.com/html-validate/html-validate/blob/master/src/rules/no-redundant-for.ts)
