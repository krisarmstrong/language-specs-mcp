GitHub - hadolint/hadolint: Dockerfile linter, validate inline bash, written in Haskell[Skip to content](#start-of-content)

## Navigation Menu

Toggle navigation/[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhadolint%2Fhadolint)Appearance settings
...
NameQuery
 ...
 Cancel  Create saved search [Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhadolint%2Fhadolint)[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=hadolint%2Fhadolint)Appearance settingsResetting focusYou signed in with another tab or window. Reload to refresh your session.You signed out in another tab or window. Reload to refresh your session.You switched accounts on another tab or window. Reload to refresh your session.Dismiss alert{{ message }}[hadolint](/hadolint)/[hadolint](/hadolint/hadolint)Public
