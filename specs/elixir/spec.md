Syntax reference — Elixir v1.19.4https://elixir-lang.org/docs.html[Elixir](https://elixir-lang.org/docs.html) v1.19.4 

Search documentation of ElixirDefaultDefaultIn-browser searchSettings

# Syntax reference

[View Source](https://github.com/elixir-lang/elixir/blob/v1.19.4/lib/elixir/pages/references/syntax-reference.md#L1)
...
To learn more about all Unicode characters allowed in atom, see the [Unicode syntax](unicode-syntax.html) document.
...
For more in-depth information, please read the "Charlists" section in the [List](List.html) module.

### #lists-tuples-and-binariesLists, tuples and binaries
...
### #maps-and-keyword-listsMaps and keyword lists
...
### #qualified-calls-remote-callsQualified calls (remote calls)
...
Aliases are constructs that expand to atoms at compile-time. The alias [String](String.html) expands to the atom `:"Elixir.String"`. Aliases must start with an ASCII uppercase character which may be followed by any ASCII letter, number, or underscore. Non-ASCII characters are not supported in aliases.
...
### #module-attributesModule attributes
...
### #left-to-right-arrowLeft to right arrow
...
### #left-to-right-arrow-1Left to right arrow
...
### #qualified-tuplesQualified tuples
...
You will find them in constructs such as `receive`, `try`, and others. You can also find more examples in [the Optional Syntax chapter](optional-syntax.html).

[← Previous Page
        
        
Patterns and guards](patterns-and-guards.html)[Next Page →
        
        
Typespecs reference](typespecs.html)
