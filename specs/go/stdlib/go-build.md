go command - cmd/go - Go Packageshttps://go.dev/[Skip to Main Content](#main-content)
...
[Go to latest](/cmd/go) Published: Dec 2, 2025  License: [BSD-3-Clause](/cmd/go?tab=licenses) Opens a new window with license information. [Imports: 38](/cmd/go?tab=imports) Opens a new window with list of imports. [Imported by: 4](/cmd/go?tab=importedby) Opens a new window with list of known importers. Main Versions  Licenses  Imports  Imported By 
...
- [Update packages to use new APIs](#hdr-Update_packages_to_use_new_APIs)
...
[View all Source files](https://cs.opensource.google/go/go/+/go1.25.5:src/cmd/go)

- [alldocs.go](https://cs.opensource.google/go/go/+/go1.25.5:src/cmd/go/alldocs.go)
- [go11.go](https://cs.opensource.google/go/go/+/go1.25.5:src/cmd/go/go11.go)
- [main.go](https://cs.opensource.google/go/go/+/go1.25.5:src/cmd/go/main.go)

##  Directories [¶](#section-directories)

 Show internal  Expand all PathSynopsisinternal[auth](/cmd/go/internal/auth@go1.25.5)Package auth provides access to user-provided authentication credentials.Package auth provides access to user-provided authentication credentials.[base](/cmd/go/internal/base@go1.25.5)Package base defines shared basic pieces of the go command, in particular logging and the Command structure.Package base defines shared basic pieces of the go command, in particular logging and the Command structure.[bug](/cmd/go/internal/bug@go1.25.5)Package bug implements the “go bug” command.Package bug implements the “go bug” command.[cache](/cmd/go/internal/cache@go1.25.5)Package cache implements a build artifact cache.Package cache implements a build artifact cache.[cacheprog](/cmd/go/internal/cacheprog@go1.25.5)Package cacheprog defines the protocol for a GOCACHEPROG program.Package cacheprog defines the protocol for a GOCACHEPROG program.[cfg](/cmd/go/internal/cfg@go1.25.5)Package cfg holds configuration shared by multiple parts of the go command.Package cfg holds configuration shared by multiple parts of the go command.[clean](/cmd/go/internal/clean@go1.25.5)Package clean implements the “go clean” command.Package clean implements the “go clean” command.[cmdflag](/cmd/go/internal/cmdflag@go1.25.5)Package cmdflag handles flag processing common to several go tools.Package cmdflag handles flag processing common to several go tools.[doc](/cmd/go/internal/doc@go1.25.5)Package doc implements the “go doc” command.Package doc implements the “go doc” command.[envcmd](/cmd/go/internal/envcmd@go1.25.5)Package envcmd implements the “go env” command.Package envcmd implements the “go env” command.[fips140](/cmd/go/internal/fips140@go1.25.5)Package fips implements support for the GOFIPS140 build setting.Package fips implements support for the GOFIPS140 build setting.[fix](/cmd/go/internal/fix@go1.25.5)Package fix implements the “go fix” command.Package fix implements the “go fix” command.[fmtcmd](/cmd/go/internal/fmtcmd@go1.25.5)Package fmtcmd implements the “go fmt” command.Package fmtcmd implements the “go fmt” command.[fsys](/cmd/go/internal/fsys@go1.25.5)Package fsys implements a virtual file system that the go command uses to read source file trees.Package fsys implements a virtual file system that the go command uses to read source file trees.[generate](/cmd/go/internal/generate@go1.25.5)Package generate implements the “go generate” command.Package generate implements the “go generate” command.[gover](/cmd/go/internal/gover@go1.25.5)Package gover implements support for Go toolchain versions like 1.21.0 and 1.21rc1.Package gover implements support for Go toolchain versions like 1.21.0 and 1.21rc1.[help](/cmd/go/internal/help@go1.25.5)Package help implements the “go help” command.Package help implements the “go help” command.[imports](/cmd/go/internal/imports@go1.25.5)[list](/cmd/go/internal/list@go1.25.5)Package list implements the “go list” command.Package list implements the “go list” command.[load](/cmd/go/internal/load@go1.25.5)Package load loads packages.Package load loads packages.[lockedfile](/cmd/go/internal/lockedfile@go1.25.5)Package lockedfile creates and manipulates files whose contents should only change atomically.Package lockedfile creates and manipulates files whose contents should only change atomically.[lockedfile/internal/filelock](/cmd/go/internal/lockedfile/internal/filelock@go1.25.5)Package filelock provides a platform-independent API for advisory file locking.Package filelock provides a platform-independent API for advisory file locking.[mmap](/cmd/go/internal/mmap@go1.25.5)The mmap package provides an abstraction for memory mapping files on different platforms.The mmap package provides an abstraction for memory mapping files on different platforms.[modcmd](/cmd/go/internal/modcmd@go1.25.5)Package modcmd implements the “go mod” command.Package modcmd implements the “go mod” command.[modfetch](/cmd/go/internal/modfetch@go1.25.5)[modfetch/codehost](/cmd/go/internal/modfetch/codehost@go1.25.5)Package codehost defines the interface implemented by a code hosting source, along with support code for use by implementations.Package codehost defines the interface implemented by a code hosting source, along with support code for use by implementations.[modget](/cmd/go/internal/modget@go1.25.5)Package modget implements the module-aware “go get” command.Package modget implements the module-aware “go get” command.[modindex](/cmd/go/internal/modindex@go1.25.5)[modinfo](/cmd/go/internal/modinfo@go1.25.5)[modload](/cmd/go/internal/modload@go1.25.5)[mvs](/cmd/go/internal/mvs@go1.25.5)Package mvs implements Minimal Version Selection.Package mvs implements Minimal Version Selection.[run](/cmd/go/internal/run@go1.25.5)Package run implements the “go run” command.Package run implements the “go run” command.[search](/cmd/go/internal/search@go1.25.5)[str](/cmd/go/internal/str@go1.25.5)Package str provides string manipulation utilities.Package str provides string manipulation utilities.[telemetrycmd](/cmd/go/internal/telemetrycmd@go1.25.5)Package telemetrycmd implements the "go telemetry" command.Package telemetrycmd implements the "go telemetry" command.[telemetrystats](/cmd/go/internal/telemetrystats@go1.25.5)[test](/cmd/go/internal/test@go1.25.5)[test/internal/genflags](/cmd/go/internal/test/internal/genflags@go1.25.5)[tool](/cmd/go/internal/tool@go1.25.5)Package tool implements the “go tool” command.Package tool implements the “go tool” command.[toolchain](/cmd/go/internal/toolchain@go1.25.5)Package toolchain implements dynamic switching of Go toolchains.Package toolchain implements dynamic switching of Go toolchains.[trace](/cmd/go/internal/trace@go1.25.5)[vcs](/cmd/go/internal/vcs@go1.25.5)[vcweb](/cmd/go/internal/vcweb@go1.25.5)Package vcweb serves version control repos for testing the go command.Package vcweb serves version control repos for testing the go command.[vcweb/vcstest](/cmd/go/internal/vcweb/vcstest@go1.25.5)Package vcstest serves the repository scripts in cmd/go/testdata/vcstest using the vcweb script engine.Package vcstest serves the repository scripts in cmd/go/testdata/vcstest using the vcweb script engine.[version](/cmd/go/internal/version@go1.25.5)Package version implements the “go version” command.Package version implements the “go version” command.[vet](/cmd/go/internal/vet@go1.25.5)Package vet implements the “go vet” command.Package vet implements the “go vet” command.[web](/cmd/go/internal/web@go1.25.5)Package web defines minimal helper routines for accessing HTTP/HTTPS resources without requiring external dependencies on the net package.Package web defines minimal helper routines for accessing HTTP/HTTPS resources without requiring external dependencies on the net package.[web/intercept](/cmd/go/internal/web/intercept@go1.25.5)[work](/cmd/go/internal/work@go1.25.5)[workcmd](/cmd/go/internal/workcmd@go1.25.5)Package workcmd implements the “go work” command.Package workcmd implements the “go work” command. Click to show internal directories.  Click to hide internal directories. [Why Go](https://go.dev/solutions)[Use Cases](https://go.dev/solutions#use-cases)[Case Studies](https://go.dev/solutions#case-studies)[Get Started](https://learn.go.dev/)[Playground](https://play.golang.org)[Tour](https://tour.golang.org)[Stack Overflow](https://stackoverflow.com/questions/tagged/go?tab=Newest)[Help](https://go.dev/help)[Packages](https://pkg.go.dev)[Standard Library](/std)[Sub-repositories](/golang.org/x)[About Go Packages](https://pkg.go.dev/about)[About](https://go.dev/project)[Download](https://go.dev/dl/)[Blog](https://go.dev/blog)[Issue Tracker](https://github.com/golang/go/issues)[Release Notes](https://go.dev/doc/devel/release.html)[Brand Guidelines](https://go.dev/brand)[Code of Conduct](https://go.dev/conduct)[Connect](https://www.twitter.com/golang)[Twitter](https://www.twitter.com/golang)[GitHub](https://github.com/golang)[Slack](https://invite.slack.golangbridge.org/)[r/golang](https://reddit.com/r/golang)[Meetup](https://www.meetup.com/pro/go)[Golang Weekly](https://golangweekly.com/)
