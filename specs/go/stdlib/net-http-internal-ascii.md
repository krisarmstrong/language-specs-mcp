...
[RFC 20
                        ...
                        Internet Standard](/doc/rfc20/)TitleASCII format for network interchangeDocumentDocument typeRFC - Internet Standard 
October 1969 
[View errata](https://www.rfc-editor.org/errata_search.php?rfc=20)[Report errata](https://www.rfc-editor.org/errata.php#reportnew)Status changed by [status-change-rfc20-ascii-format-to-standard](/doc/status-change-rfc20-ascii-format-to-standard/)Select version

- [RFC 20](/doc/html/rfc20)

Authors
[Email authors](mailto:rfc20@ietf.org?subject=rfc20) RFC stream  Legacy  Other formats [txt](https://www.rfc-editor.org/rfc/rfc20.txt)[html](https://www.rfc-editor.org/rfc/rfc20.html)[pdf](https://www.rfc-editor.org/rfc/rfc20.pdf)[w/errata](https://www.rfc-editor.org/rfc/inline-errata/rfc20.html)[bibtex](/doc/rfc20/bibtex/)[Report a bug](https://github.com/ietf-tools/datatracker/issues/new/choose)
...
RFC 20/doc/html/rfc20            ASCII format for Network Interchange      October 1969

2#section-2. Standard Code
...
3#section-3. Character Representation and Code Identification
...
4.1#section-4.1 Control Characters
...
4.2#section-4.2 Graphic Characters
   ...
   as diacritical marks is described in Appendix A#appendix-A, A5.2
   ...
   recipient.  (See Appendix B#appendix-B4.)
...
5.2#section-5.2 Control Characters
...
5.3#section-5.3 Graphic Characters
...
6#section-6. General Considerations
...
Authors
[Email authors](mailto:rfc20@ietf.org?subject=rfc20) RFC stream  Legacy  Other formats [txt](https://www.rfc-editor.org/rfc/rfc20.txt)[html](https://www.rfc-editor.org/rfc/rfc20.html)[pdf](https://www.rfc-editor.org/rfc/rfc20.pdf)[w/errata](https://www.rfc-editor.org/rfc/inline-errata/rfc20.html)[bibtex](/doc/rfc20/bibtex/)[Report a datatracker bug](https://github.com/ietf-tools/datatracker/issues/new/choose)Show sidebar by defaultYesNoTab to show by defaultInfo Contents HTMLization configurationHTMLize the plaintext Plaintextify the HTML Maximum font sizePage dependenciesInline Reference Citation links Go to reference section Go to linked document
