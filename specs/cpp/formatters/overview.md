...
## ClangFormat
 ...
 « [ClangCheck](ClangCheck.html) :: [Contents](index.html) :: [Clang-Format Style Options](ClangFormatStyleOptions.html) » 

# ClangFormat[¶](#clangformat)

ClangFormat describes a set of tools that are built on top of [LibFormat](LibFormat.html). It can support your workflow in a variety of ways including a standalone tool and editor integrations.
...
Available style options are described in [Clang-Format Style Options](ClangFormatStyleOptions.html).
...
## BBEdit Integration[¶](#bbedit-integration)
...
## CLion Integration[¶](#clion-integration)
