ShellCheck: SC1018 – This is a Unicode non-breaking space. Delete it and retype as space.

# SC1018 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC1018)
...
```
#cb1-1sed -e $'s/\xC2\xA0/ /g' -e $'s/\xE2\x80\x8b//g' -i yourfile
```
