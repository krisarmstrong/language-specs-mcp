ShellCheck: SC1041 – Found `eof` further down, but not on a separate line.

# SC1041 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC1041)
...
You will get some companion [SC1042](SC1042) errors mentioning lines that contain the string as a substring, though they all point to the start of the here document and not the relevant line:
...
Note that SC1041 and [SC1042](SC1042) swapped numbers after v0.4.6 to improve the display order. This rare instance of number reuse was justified by them always occurring together on the same line.
