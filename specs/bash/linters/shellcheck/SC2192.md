ShellCheck: SC2192 – This array element has no value. Remove spaces after `=` or use `""` for empty string.

# SC2192 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2192)
...
```
#cb1-1array=([1]=one [2]= two)
```

### Correct code:

```
#cb2-1array=([1]=one [2]=two)
```
