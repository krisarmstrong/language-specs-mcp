ShellCheck: SC2035 – Use `./*glob*` or `-- *glob*` so names with dashes won't become options.

# SC2035 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2035)
...
For more information, see "[Filenames and
Pathnames in Shell: How to do it Correctly](https://dwheeler.com/essays/filenames-in-shell.html)".
