ShellCheck: SC1000 – `$` is not used specially and should therefore be escaped.

# SC1000 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC1000)

[Sitemap](index.html)

# `$` is not used specially and should therefore be escaped.

Note: Removed in [v0.3.3
- 2014-05-29](https://github.com/koalaman/shellcheck/blob/2e5c56b27034492134be1538c1e1e6a533ca791a/CHANGELOG.md#removed-1)
