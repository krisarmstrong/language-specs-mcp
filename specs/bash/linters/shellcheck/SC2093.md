ShellCheck: SC2093 – Remove `exec ` if script should continue after this command.

# SC2093 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2093)
...
```
#cb1-1echo "Starting compilation"
#cb1-2exec ./compile
#cb1-3echo "Starting deployment"
#cb1-4exec ./deploy
```
...
```
#cb2-1echo "Starting compilation"
#cb2-2./compile
#cb2-3echo "Starting deployment"
#cb2-4./deploy
```
...
- StackOverflow: [My
shell script stops after exec](https://stackoverflow.com/questions/3877657/my-shell-script-stops-after-exec)
