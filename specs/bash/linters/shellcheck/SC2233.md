ShellCheck: SC2233 – Remove superfluous `(..)` around condition to avoid subshell overhead.

# SC2233 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2233)
...
This issue only affects performance, not correctness, so it can be safely [ignore](ignore)d.
