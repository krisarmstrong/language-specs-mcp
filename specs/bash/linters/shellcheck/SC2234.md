ShellCheck: SC2234 – Remove superfluous `(..)` around test command to avoid subshell overhead.

# SC2234 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2234)
...
This issue only affects performance, not correctness, and can be [ignore](ignore)d for stylistic reasons.
