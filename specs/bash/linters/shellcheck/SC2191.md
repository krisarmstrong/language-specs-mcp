ShellCheck: SC2191 – The `=` here is literal. To assign by index, use `( [index]=value )` with no spaces. To keep as literal, quote it.

# SC2191 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2191)
...
```
#cb1-1array=( [index] = value )
```

### Correct code:

```
#cb2-1array=( [index]=value )
```
