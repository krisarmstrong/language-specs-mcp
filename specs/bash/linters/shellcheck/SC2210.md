ShellCheck: SC2210 – This is a file redirection. Was it supposed to be a comparison or fd operation?

# SC2210 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2210)
...
```
#cb1-1if x > 5; then echo "true"; fi
```

or

```
#cb2-1foo > /dev/null 2>1
```

### Correct code:

```
#cb3-1if (( x > 5 )); then echo "true"; fi
```

or

```
#cb4-1foo > /dev/null 2>&1
```
