ShellCheck: SC2145 – Argument mixes string and array. Use `*` or separate argument.

# SC2145 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2145)
