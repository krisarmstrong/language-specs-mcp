ShellCheck: SC2232 – Can't use `sudo` with builtins like `cd`. Did you want `sudo sh -c ..` instead?

# SC2232 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2232)
