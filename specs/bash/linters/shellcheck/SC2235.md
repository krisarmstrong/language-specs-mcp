ShellCheck: SC2235 – Use `{ ..; }` instead of `(..)` to avoid subshell overhead.

# SC2235 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2235)
