ShellCheck: SC2238 – Redirecting to/from command name instead of file. Did you want pipes/xargs (or quote to ignore)?

# SC2238 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2238)
...
```
#cb2-1cat file | tr -d '\r'         # tr reads stdin
#cb2-2cat file | xargs -d '\n' rm   # rm reads arguments
```
...
```
#cb3-1# Write to a file literally named 'rm', does not try to delete anything
#cb3-2echo "A potentially dangerous command" > "rm" 
```
