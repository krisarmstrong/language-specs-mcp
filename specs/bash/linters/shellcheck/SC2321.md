ShellCheck: SC2321 – Array indices are already arithmetic contexts. Prefer removing the `$((` and `))`.

# SC2321 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2321)
