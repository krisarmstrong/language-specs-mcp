ShellCheck: SC1132 – This `&` terminates the command. Escape it or add space after `&` to silence.

# SC1132 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC1132)
...
```
#cb1-1curl https://www.google.com/search?q=cats&tbm=isch
```

### Correct code:

```
#cb2-1curl "https://www.google.com/search?q=cats&tbm=isch"
```
