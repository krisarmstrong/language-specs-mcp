ShellCheck: SC2036 – If you wanted to assign the output of the pipeline, use `a=$(b | c)` .

# SC2036 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2036)
