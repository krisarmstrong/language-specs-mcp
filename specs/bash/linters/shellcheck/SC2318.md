ShellCheck: SC2318 – This assignment is used again in this `declare`, but won't have taken effect. Use two `declare`s.

# SC2318 – ShellCheck Wiki

[See this page on GitHub](https://github.com/koalaman/shellcheck/wiki/SC2318)
...
```
#cb1-1declare -i first=$1 current=$first
```

### Correct code:

```
#cb2-1declare -i first=$1
#cb2-2declare -i current=$first
```
