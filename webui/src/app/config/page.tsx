...
import { AlertCircle, Check, RefreshCw, Save, Settings } from "lucide-react";
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-3xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Configuration</h1>
          <p className="text-slate-600 dark:text-slate-300">Configure SpecForge plugin settings</p>
        </header>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={config.theme}
                  onChange={(e) =>
                    setConfig({ ...config, theme: e.target.value as Config["theme"] })
                  }
                  className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white"
                >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Cache spec files and search indexes</p>
                </div>
                <button
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, cacheTTL: Number.parseInt(e.target.value) || 60000 })
                  }
                  className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig({
                      ...config,
                      resourcePageSize: Number.parseInt(e.target.value) || 250,
                    })
                  }
                  min={25}
                  max={1000}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                Some settings may require restarting the plugin to take effect. Environment
                variables take precedence over these settings.
              </p>
            </div>
          </div>
        </div>
