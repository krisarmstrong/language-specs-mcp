...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const config: Config = {
      ...
      cacheEnabled:
        typeof body.cacheEnabled === "boolean" ? body.cacheEnabled : DEFAULT_CONFIG.cacheEnabled,
      cacheTTL: typeof body.cacheTTL === "number" ? body.cacheTTL : DEFAULT_CONFIG.cacheTTL,
      searchFallback:
        typeof body.searchFallback === "boolean"
          ? body.searchFallback
          : DEFAULT_CONFIG.searchFallback,
      resourcePageSize:
        typeof body.resourcePageSize === "number"
          ? body.resourcePageSize
          : DEFAULT_CONFIG.resourcePageSize,
