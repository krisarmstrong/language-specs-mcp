import { Book, Brain, FileCode, Search, Settings, Shield } from "lucide-react";
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">SpecForge</h1>
        ...
        <section className="mt-12 p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-4 text-slate-600 dark:text-slate-300">
            <p>
              <strong>Before writing code:</strong> Use{" "}
              <code className="bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded">
                /checklist &lt;language&gt;
              </code>{" "}
              to get the pre-coding checklist.
            </p>
            <p>
              <strong>For linter help:</strong> Use{" "}
              <code className="bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded">
                /lint-rule &lt;language&gt; &lt;linter&gt; &lt;rule&gt;
              </code>{" "}
              to understand why a rule exists.
            </p>
            <p>
              <strong>Search specs:</strong> Use{" "}
              <code className="bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded">
                /search-specs &lt;query&gt;
              </code>{" "}
              to find patterns across all languages.
            </p>
          </div>
        </section>
        ...
        <section className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
          ...
          <p className="text-blue-800 dark:text-blue-200 text-sm">
            assembly, basic, bash, batch, c, cpp, csharp, css, go, javascript, html, git, java,
            kotlin, lua, php, ruby, dart, r, julia, scala, elixir, clojure, haskell, zig, ocaml,
            markdown, yaml, dockerfile, powershell, python, rust, sql, swift, typescript
          </p>
        </section>
      </div>
    </div>
